...
extension XString on String {
  String genAsCharset(int length) => List.generate(
    length,
    (index) => this[Random().nextInt(this.length)],
  ).join();
}
...
final Map<String, String> charsets = {
  ...
  "arabic":
      "${_c(0x0600, 0x06ff, {0x061A, 0x061D, 0x653})}${_c(0x0750, 0x077f)}${_c(0x08a0, 0x08bd)}",
